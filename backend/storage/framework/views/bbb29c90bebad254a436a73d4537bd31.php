        ...
        <div class="absolute inset-4 border border-gray-800/50 rounded-2xl pointer-events-none"></div>
            ...
            <div class="flex-1 flex flex-col justify-center w-full max-w-4xl space-y-6 -mt-8">
                ...
                <div class="space-y-4 text-center">
                    ...
                    <h2 class="text-6xl font-black tracking-tight text-white mb-2 leading-none"><?php echo e($student_name); ?></h2>
                </div>
            ...
            <div class="grid grid-cols-3 w-full max-w-5xl items-end px-12 pb-10">
                ...
                <!-- Date -->
                <div class="text-left">
                    <div class="text-2xl font-bold text-white mb-1"><?php echo e($date); ?></div>
...
<?php /**PATH /Users/hermes/Documents/GitHub/VidaduAcademy/backend/resources/views/certificates/premium.blade.php ENDPATH**/ ?>