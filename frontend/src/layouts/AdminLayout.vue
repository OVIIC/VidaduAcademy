  ...
  <div class="h-screen flex bg-black overflow-hidden">
    ...
    >
      <div class="p-6 flex items-center justify-between">
        <router-link to="/admin" class="flex items-center gap-2 overflow-hidden whitespace-nowrap">
      ...
      <nav class="flex-1 px-4 space-y-1 overflow-y-auto">
        ...
        >
          <component 
            ...
            :class="[
              $route.path === item.href ? 'text-red-500' : 'text-gray-500 group-hover:text-gray-300',
              isCollapsed ? '' : 'mr-3'
            ]"
          />
          <span 
      ...
      <div class="p-4 border-t border-gray-800 mt-auto">
        <div class="flex items-center gap-3" :class="{ 'justify-center': isCollapsed }">
          <div class="h-8 w-8 rounded-full bg-red-900/30 flex items-center justify-center text-red-500 font-bold border border-red-900/50 flex-shrink-0">
            AD
          </div>
          <div 
    ...
    <div class="flex-1 flex flex-col min-w-0 overflow-hidden">
      ...
      <div class="md:hidden bg-black border-b border-gray-800 p-4 flex items-center justify-between">
        <span class="font-bold text-xl text-white">Admin</span>
