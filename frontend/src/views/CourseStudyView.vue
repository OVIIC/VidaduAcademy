        ...
        <div class="flex items-start justify-between">
          <div class="flex-1">
            <nav class="text-sm text-gray-400 mb-2">
              <router-link to="/my-courses" class="hover:text-primary-500">Moje kurzy</router-link>
          ...
          <div class="flex-shrink-0 ml-6">
            <div class="relative w-20 h-20">
              ...
              <div class="absolute inset-0 flex items-center justify-center">
                <span class="text-sm font-semibold text-white">{{ Math.round(progressPercentage) }}%</span>
              </div>
            </div>
          </div>
        </div>
          ...
          <div v-if="selectedLesson" ref="lessonContentRef" class="bg-secondary-surface border border-gray-700/50 rounded-lg shadow-sm overflow-hidden">
            ...
            <div class="p-6">
              <div v-if="selectedLesson.description" class="mb-6">
                <h3 class="text-lg font-semibold text-white mb-3">Popis lekcie</h3>
                <p class="text-gray-300">{{ selectedLesson.description }}</p>
              </div>

              <div v-if="selectedLesson.content" class="mb-6">
                <h3 class="text-lg font-semibold text-white mb-3">Obsah lekcie</h3>
                <div class="prose max-w-none text-gray-300" v-html="selectedLesson.content"></div>
              </div>
